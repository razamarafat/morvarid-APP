  ...
  addUser: async (userData) => {
      ...
      try {
          ...
          if (data.user) {
              ...
              if (isAutoGenerated) {
                   // In a real app, send via email. Here we show a persistent toast or log for the admin to copy.
                   console.log(`[Security] Auto-generated password for ${sanitizedUsername}: ${password}`);
                   alert(`کاربر ایجاد شد.\n\nنام کاربری: ${sanitizedUsername}\nرمز عبور (تولید شده): ${password}\n\nلطفا این رمز را یادداشت کنید.`);
              }
