  ...
  return (
    ...
    >
        ...
        <div className="relative z-10 flex justify-between items-start">
             <Icon className="w-6 h-6 md:w-8 md:h-8 lg:w-10 lg:h-10 text-white drop-shadow-md" />
             {count !== undefined && (
                 <span className="text-xl md:text-2xl lg:text-4xl font-black text-white drop-shadow-md tracking-tight">{count}</span>
             )}
        </div>
        <div className="relative z-10 mt-auto">
            <h3 className="text-white font-bold text-sm md:text-lg lg:text-xl leading-tight drop-shadow-sm tracking-wide">
                {title}
            </h3>
        </div>
    </motion.div>
